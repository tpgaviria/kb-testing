...
updatedAt: "2020-06-18T23:40:03.700Z"
---
[block:callout]
{
  "type": "danger",
...
The first step is to define some incident priorities in your PagerDuty account, by going to **Configuration** :fa-arrow-right: **Account Settings** :fa-arrow-right: **Incident Priorities.**
